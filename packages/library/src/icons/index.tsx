...
export const CopyIcon = memo(
  forwardRef<SVGSVGElement, PropsType>((props, ref) => {
  ...
  forwardRef<SVGSVGElement, PropsType>((props, ref) => {
    ...
    return (
      ...
      >
        ...
        <path
          d="M-10 100h30c30 0 50-20 50-50s-20-50-50-50H0v100z"
          fill="url(#grad)"
        />
        <path
          d="M20 100h70c-30 0-50-20-50-50s20-50 50-50v100H80z"
          fill="url(#grad)"
        />
      </svg>
    );
