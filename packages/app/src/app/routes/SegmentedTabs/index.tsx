...
import { LazyImageWithLoader, SegmentedTabs } from "smart-components-dinkar";
...
export function SegmentedTabsPage() {
  ...
  return (
    <main>
      ...
      <p>
        Demon Slayer: Kimetsu no Yaiba ("Blade of Demon Destruction") is a
        Japanese manga series written and illustrated by Koyoharu Gotouge.
      </p>
